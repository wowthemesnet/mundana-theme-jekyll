---
layout: post
title: "Matrix Multiplications 02"
author: dionne
...
- ex) c[i, :] = c [i]
2) _any number of colon commas at the start, you can switch it with the single elipsis._
- ex) c[:,:,:,:,i] = c [...,i]
...
- [fast.ai forum note](https://forums.fast.ai/t/lesson-8-notes/41442)
