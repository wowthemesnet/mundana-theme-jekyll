...
2. import data
	...
	* Initialize the model ***(1st)***
		- init with size of nodes
		- instance call with independent variable(s), returning prediction
...
3. Negative log likelihood function [^1]
	...
	* Why do we find a `negative` value

4. LogSumExp
	* What is LogSumExp
	* Why this is called trick somehow?
	* re-implement log_softmax function using logsumexp
